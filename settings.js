...
SESSION_ID: process.env.SESSION_ID === undefined ? '' : process.env.VAJIRA-MD=XUExnQLa#Xfn9VBUBm2s3C4EOf24Uuuy2czUk6iL2reKwlq8cFcw,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '' : process.env.923047227164,   
